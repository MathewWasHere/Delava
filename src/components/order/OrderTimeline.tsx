  ...
  return (
    <span
      className={cn(
        ...
        state === "active" &&
          "bg-flame-600 text-white ring-4 ring-flame-500/20 shadow-[0_0_0_1px_rgba(238,109,27,0.5)]",
