        ...
        <div className="lg:sticky lg:top-28 lg:self-start">
          ...
          <div className="mt-4 grid grid-cols-3 gap-3">
            {[
              ...
              { icon: "flame" as const, label: "فروش", value: `${toFa(product.soldCount)}+` },
            ].map((s) => (
        ...
        <div>
          <div className="flex flex-col items-start gap-3 sm:flex-row sm:justify-between sm:gap-4">
            <div>
              ...
              <div className="mt-2 flex items-center gap-3">
                <Rating value={product.rating} count={product.soldCount} />
                {product.available ? (
          ...
          <div className="mt-8 hidden items-center gap-4 rounded-2xl border border-[var(--surface-border)] bg-ink-850 p-4 lg:flex">
            ...
            <div className="flex-1">
              ...
              <div className="num text-xl font-extrabold text-mist-100">{faNumber(total)} تومان</div>
            </div>
            <Button
              size="lg"
