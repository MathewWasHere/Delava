...
export const metadata: Metadata = {
  title: "درباره دلاوا",
  description:
    "فست فود دلاوا در فسا؛ داستان ما، ساعات کاری، آدرس و شماره تماس. سفارش مستقیم بدون واسطه.",
};
    ...
    <div className="pb-24 lg:pb-10">
      <section className="relative">
        <div className="absolute inset-0">
          <Image
            src="/brand/sign-round.webp"
            alt="تابلوی گرد فست فود دلاوا"
            fill
            sizes="100vw"
        ...
        <div className="shell relative py-20 text-center">
          ...
          <h1 className="mt-4 text-4xl font-extrabold text-mist-100 sm:text-5xl">داستان دلاوا</h1>
          <p className="mx-auto mt-5 max-w-2xl text-[15px] leading-9 text-mist-300">
            دلاوا از یک ایده ساده شروع شد: فست فودی در فسا که غذایش واقعاً تازه باشد و مشتری برای
            سفارش دادن مجبور نباشد از چند واسطه رد شود. تابلوی نارنجی‌مان زیر آسمان شب فسا روشن است و
            همین رنگ و همین حال‌وهوا را به این وب‌اپلیکیشن هم آورده‌ایم.
          </p>
      ...
      <section className="shell py-14">
        <div className="grid gap-4 sm:grid-cols-3">
          {[
            { icon: "flame" as const, title: "گریل ذغالی", text: "برگرهای دلاوا روی شعله مستقیم پخته می‌شوند، نه روی تابه." },
        ...
        <div className="grid gap-6 lg:grid-cols-[1fr_1fr]">
          ...
          <div className="relative min-h-72 overflow-hidden rounded-2xl border border-[var(--surface-border)]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-6">
              ...
              <div className="mt-1 text-[15px] font-extrabold text-mist-100">فست فود دلاوا، فسا</div>
            </div>
          </div>
        </div>
      </section>
