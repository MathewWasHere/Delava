            ...
            {order.status === "OUT_FOR_DELIVERY" && (
              <div className="flex items-center gap-3 border-t border-[var(--surface-border)] bg-ink-850 p-4">
                ...
                <div className="flex-1">
                  <div className="text-[13px] font-bold text-mist-100">پیک دلاوا در راه است</div>
                  <div className="text-[13px] text-mist-400">{order.driverName ?? "پیک اختصاصی دلاوا"}</div>
                </div>
                <a
        ...
        <aside className="space-y-4 lg:sticky lg:top-28 lg:self-start">
          ...
          >
            <span>
              ...
              <span className="block text-[13px] text-mist-400">مستقیم با دلاوا تماس بگیر</span>
            </span>
