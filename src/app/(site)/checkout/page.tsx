    ...
    return (
      <div className="flex min-h-[80vh] flex-col items-center justify-center px-6 text-center">
        {paying === "redirect" ? (
          ...
          <>
            <span className="grid size-20 animate-pop place-items-center rounded-full bg-emerald-500/15 text-4xl text-emerald-400">
              ✓
            </span>
    ...
    <div className="shell py-5 pb-28 sm:py-8 lg:pb-14">
          ...
          return (
            <li key={label} className="flex flex-1 items-center gap-1.5">
              ...
              >
                <span
                  className={cn(
                    "num grid size-5 place-items-center rounded-full text-[13px]",
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-4">
          ...
          {/* STEP 2 — address */}
          {step === 2 && (
            <div className="surface animate-fade-up rounded-3xl p-4 sm:p-6">
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="text-[13px] font-bold text-flame-400 hover:text-flame-300"
                >
                  + آدرس جدید
                </button>
              </div>
                      ...
                      >
                        <button onClick={() => selectAddress(a.id)} className="w-full text-right">
                          <div className="flex items-center justify-between">
                            <span className="flex items-center gap-2">
                              <span
                                className={cn(
                                  "grid size-5 place-items-center rounded-full border text-[13px]",
                        ...
                        <div className="mt-3 flex gap-2 border-t border-[var(--surface-border)] pt-3">
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 rounded-lg px-2 py-1 text-[13px] text-mist-400 hover:text-red-400"
                          >
              ...
              <div className="mt-5 grid gap-3 sm:grid-cols-2">
                {(
                  ...
                  >
                    ...
                    <span className="num mt-2 block text-[13px] font-bold text-flame-400">{opt.price}</span>
                  </button>
                ))}
              </div>
          ...
          <div className="surface rounded-3xl p-4 sm:p-5">
            ...
            <div className="mt-4 space-y-3 border-b border-[var(--surface-border)] pb-4 text-[13px]">
              ...
              <div className="flex justify-between">
                ...
                <span className={cn("num font-bold", totals.discount > 0 ? "text-flame-400" : "text-mist-100")}>
                  {totals.discount > 0 ? "−" : ""}
            ...
            {totals.appliedCoupon && (
              <p className="mt-2 text-[13px] text-emerald-400">✓ {totals.appliedCoupon.description}</p>
            )}
