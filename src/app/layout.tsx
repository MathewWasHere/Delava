...
export const metadata: Metadata = {
  metadataBase: new URL("https://delava.ir"),
  title: {
    default: "فست فود دلاوا | سفارش آنلاین در فسا",
    template: "%s | فست فود دلاوا",
  },
  description:
    "سفارش آنلاین مستقیم از فست فود دلاوا در فسا. برگر، پیتزا، ساندویچ و سوخاری تازه با ارسال سریع. طعمی که دوباره دلت می‌خواد.",
  keywords: ["فست فود دلاوا", "دلاوا فسا", "سفارش آنلاین غذا فسا", "پیتزا فسا", "برگر فسا"],
  applicationName: "دلاوا",
  manifest: "/manifest.webmanifest",
  appleWebApp: { capable: true, title: "دلاوا", statusBarStyle: "black-translucent" },
  openGraph: {
    type: "website",
    locale: "fa_IR",
    siteName: "فست فود دلاوا",
    title: "فست فود دلاوا | سفارش آنلاین",
    description: "برگر، پیتزا و سوخاری تازه دلاوا — سفارش مستقیم، ارسال سریع در فسا.",
    images: [{ url: "/brand/delava-social-dark.png", width: 1080, height: 1080, alt: "فست فود دلاوا" }],
  },
  icons: {
    icon: [
...
const jsonLd = {
  ...
  alternateName: "DELAVA Fast Food",
  image: "https://delava.ir/brand/delava-social-dark.png",
